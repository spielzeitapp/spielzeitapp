...
assert.match(edge, /flow: \{ type: 'string', maxLength: 360 \}/);
...
assert.match(edge, /'flow: höchstens 320 Zeichen'/);
assert.match(edge, /'flow: höchstens 360 Zeichen'/);
assert.match(edge, /variations: höchstens drei Einträge mit jeweils maximal 90 Zeichen/);
