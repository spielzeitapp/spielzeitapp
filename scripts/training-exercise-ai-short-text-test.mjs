...
assert.match(edge, /setup: \{ type: 'string', maxLength: 70 \}/);
assert.match(edge, /flow: \{ type: 'string', maxLength: 190 \}/);
...
assert.match(edge, /flow: höchstens 190 Zeichen aus ablauf/);
