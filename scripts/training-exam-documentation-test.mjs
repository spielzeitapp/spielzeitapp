...
const checks = [
  ...
  [pdf.includes("LiberationSans-Regular.ttf?url"), 'Eingebettete PDF-Standardschrift fehlt'],
  [pdf.includes("LiberationSans-Bold.ttf?url"), 'Eingebettete fette PDF-Schrift fehlt'],
  [pdf.includes('await registerPdfFonts(pdf)'), 'PDF-Schriften werden nicht vor dem Zeichnen registriert'],
  [pdf.includes('pdf.setCharSpace(0)'), 'Normaler Zeichenabstand wird nicht erzwungen'],
  [pdf.includes('normalizeContentSections'), 'Einheitliche Umbrüche für Aufbau, Ablauf und Variationen fehlen'],
  [pdf.includes('normalizeList(coachingParts'), 'Coachingpunkte werden nicht als einheitliche Liste formatiert'],
