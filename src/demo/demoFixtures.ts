...
export function createInitialLiveState(): DemoLiveState {
  return {
    ...
    events: [
      ...
      { id: 'le2', minute: 12, text: 'TOR Rohrbach – Lena M. (12\')', type: 'goal_home' },
...
export const demoFixtures: DemoFixtures = {
  ...
  players: [
    { id: 'p01', firstName: 'Leon', lastName: 'Huber', lastInitial: 'H.', position: 'TW', jersey: 1, available: true, trainingPct: 91, appearances: 8, goals: 0, aiGenerated: true },
    { id: 'p02', firstName: 'Max', lastName: 'Steiner', lastInitial: 'S.', position: 'AV', jersey: 2, available: true, trainingPct: 87, appearances: 7, goals: 0, aiGenerated: true },
    { id: 'p03', firstName: 'Felix', lastName: 'Berger', lastInitial: 'B.', position: 'IV', jersey: 4, available: true, trainingPct: 90, appearances: 8, goals: 1, aiGenerated: true },
    { id: 'p04', firstName: 'Mia', lastName: 'Reiter', lastInitial: 'R.', position: 'IV', jersey: 5, available: true, trainingPct: 79, appearances: 6, goals: 0, aiGenerated: true },
    { id: 'p05', firstName: 'David', lastName: 'König', lastInitial: 'K.', position: 'AV', jersey: 3, available: false, trainingPct: 68, appearances: 5, goals: 0, aiGenerated: true },
    { id: 'p06', firstName: 'Jonas', lastName: 'Wagner', lastInitial: 'W.', position: 'ZM', jersey: 6, available: true, trainingPct: 89, appearances: 8, goals: 3, aiGenerated: true },
    { id: 'p07', firstName: 'Lena', lastName: 'Mayer', lastInitial: 'M.', position: 'ZM', jersey: 8, available: true, trainingPct: 83, appearances: 7, goals: 4, aiGenerated: true },
    { id: 'p08', firstName: 'Noah', lastName: 'Kramer', lastInitial: 'K.', position: 'OM', jersey: 10, available: true, trainingPct: 93, appearances: 8, goals: 5, aiGenerated: true },
    { id: 'p09', firstName: 'Tim', lastName: 'Pichler', lastInitial: 'P.', position: 'OM', jersey: 7, available: true, trainingPct: 77, appearances: 6, goals: 2, aiGenerated: true },
    { id: 'p10', firstName: 'Elias', lastName: 'Fischer', lastInitial: 'F.', position: 'ST', jersey: 9, available: true, trainingPct: 86, appearances: 7, goals: 6, aiGenerated: true },
    { id: 'p11', firstName: 'Ben', lastName: 'Leitner', lastInitial: 'L.', position: 'ST', jersey: 11, available: true, trainingPct: 80, appearances: 6, goals: 3, aiGenerated: true },
    { id: 'p12', firstName: 'Samuel', lastName: 'Thaler', lastInitial: 'T.', position: 'AV', jersey: 12, available: true, trainingPct: 73, appearances: 4, goals: 0, aiGenerated: true },
  ],
  events: [
    {
      id: 'ev-train-past',
    ...
    },
    {
      ...
      kind: 'training',
      title: 'Training',
      startsAt: '2026-09-03T17:00:00+02:00',
      endsAt: '2026-09-03T18:20:00+02:00',
      location: 'Sportplatz Rohrbach',
      rsvpYes: 10,
      rsvpNo: 2,
      rsvpOpen: 3,
    ...
    },
    {
      ...
      startsAt: '2026-08-18T17:00:00+02:00',
      endsAt: '2026-08-18T18:20:00+02:00',
      location: 'Sportplatz Rohrbach',
      rsvpYes: 0,
      rsvpNo: 0,
      rsvpOpen: 15,
  ...
  lineup: [
    ...
    { playerId: 'p04', role: 'start', positionLabel: 'AV' },
    ...
    { playerId: 'p05', role: 'bench', positionLabel: 'AV' },
