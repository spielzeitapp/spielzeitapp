...
export const demoFixtures: DemoFixtures = {
  ...
  players: [
    { id: 'p01', firstName: 'Leon', lastInitial: 'H.', position: 'TW', jersey: 1, available: true, trainingPct: 91, appearances: 8, goals: 0, aiGenerated: true },
    { id: 'p02', firstName: 'Max', lastInitial: 'S.', position: 'AV', jersey: 2, available: true, trainingPct: 87, appearances: 7, goals: 0, aiGenerated: true },
    { id: 'p03', firstName: 'Felix', lastInitial: 'B.', position: 'IV', jersey: 4, available: true, trainingPct: 90, appearances: 8, goals: 1, aiGenerated: true },
    { id: 'p04', firstName: 'Mia', lastInitial: 'R.', position: 'IV', jersey: 5, available: true, trainingPct: 79, appearances: 6, goals: 0, aiGenerated: true },
    { id: 'p05', firstName: 'David', lastInitial: 'K.', position: 'AV', jersey: 3, available: false, trainingPct: 68, appearances: 5, goals: 0, aiGenerated: true },
    { id: 'p06', firstName: 'Jonas', lastInitial: 'W.', position: 'ZM', jersey: 6, available: true, trainingPct: 89, appearances: 8, goals: 3, aiGenerated: true },
    { id: 'p07', firstName: 'Lena', lastInitial: 'M.', position: 'ZM', jersey: 8, available: true, trainingPct: 83, appearances: 7, goals: 4, aiGenerated: true },
    { id: 'p08', firstName: 'Noah', lastInitial: 'K.', position: 'OM', jersey: 10, available: true, trainingPct: 93, appearances: 8, goals: 5, aiGenerated: true },
    { id: 'p09', firstName: 'Tim', lastInitial: 'P.', position: 'OM', jersey: 7, available: true, trainingPct: 77, appearances: 6, goals: 2, aiGenerated: true },
    { id: 'p10', firstName: 'Elias', lastInitial: 'F.', position: 'ST', jersey: 9, available: true, trainingPct: 86, appearances: 7, goals: 6, aiGenerated: true },
    { id: 'p11', firstName: 'Ben', lastInitial: 'L.', position: 'ST', jersey: 11, available: true, trainingPct: 80, appearances: 6, goals: 3, aiGenerated: true },
    { id: 'p12', firstName: 'Samuel', lastInitial: 'T.', position: 'AV', jersey: 12, available: true, trainingPct: 73, appearances: 4, goals: 0, aiGenerated: true },
  ],
  events: [
    {
      id: 'ev-train-past',
