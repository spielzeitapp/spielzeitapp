...
export const SetPasswordPage: React.FC = () => {
  ...
  useEffect(() => {
    // Tastatur / Gmail-WebView: fokussiertes Feld sichtbar halten
    ...
    <div className="py-2">
      <Card>
        ...
        <p className="mt-1 text-sm text-[var(--text-sub)]">
          Lege ein Passwort für die Anmeldung fest. Danach kannst du dich mit E-Mail und Passwort
          einloggen. (Auch nach „Passwort vergessen“ landest du hier, um ein neues Passwort zu setzen.)
        </p>
        {success ? (
