...
export const U11_FORMATIONS: Record<U11FormationId, FormationSlotLayout[]> = {
  '1-2-2-2': [
    { slot: 'GK', label: 'GK', x: 50, y: 88 },
    { slot: 'LB', label: 'LV', x: 30, y: 68 },
    { slot: 'RB', label: 'RV', x: 70, y: 68 },
    { slot: 'LW', label: 'LM', x: 30, y: 45 },
    { slot: 'RW', label: 'RM', x: 70, y: 45 },
  ...
  '1-2-3-1': [
    ...
    { slot: 'LB', label: 'LV', x: 30, y: 68 },
    { slot: 'RB', label: 'RV', x: 70, y: 68 },
    { slot: 'LW', label: 'LA', x: 22, y: 45 },
    { slot: 'CM', label: 'ZM', x: 50, y: 45 },
    { slot: 'RW', label: 'RA', x: 78, y: 45 },
    { slot: 'ST', label: 'ST', x: 50, y: 22 },
  ],
  '1-3-2-1': [
    { slot: 'GK', label: 'GK', x: 50, y: 88 },
    { slot: 'LB', label: 'LV', x: 22, y: 68 },
    { slot: 'CM', label: 'IV', x: 50, y: 68 },
    { slot: 'RB', label: 'RV', x: 78, y: 68 },
