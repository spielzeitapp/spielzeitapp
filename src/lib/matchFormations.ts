...
export const U11_FORMATIONS: Record<U11FormationId, FormationSlotLayout[]> = {
  ...
  '1-2-3-1': [
    ...
    { slot: 'LW', label: 'LA', x: 13, y: 38, labelDx: 6, labelDy: -2 },
    { slot: 'CM', label: 'ZM', x: 48, y: 45, labelDx: -3, labelDy: -3 },
    { slot: 'RW', label: 'RA', x: 87, y: 38, labelDx: -6, labelDy: -2 },
    { slot: 'ST', label: 'ST', x: 56, y: 19, labelDx: 6, labelDy: 0 },
  ],
  '1-3-2-1': [
    { slot: 'GK', label: 'GK', x: 50, y: 86, labelDy: -5 },
