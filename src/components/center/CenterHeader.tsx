...
export function CenterHeader({ title, backLabel = 'Zurück zum Spielplan' }: Props) {
  return (
    <header className="relative flex min-h-[40px] items-center justify-between gap-2">
      ...
      <h1 className="pointer-events-none absolute left-1/2 top-1/2 max-w-[min(58vw,14rem)] -translate-x-1/2 -translate-y-1/2 truncate text-center text-[16px] font-bold leading-none tracking-tight text-white">
        {title}
      </h1>
