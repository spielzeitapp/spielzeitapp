...
export function PremiumHeroStadiumAtmosphere({ photoBgUrl }: { photoBgUrl: string }) {
  return (
    <div className="pointer-events-none absolute inset-0 z-0" aria-hidden>
      ...
      <div className="opacity-[0.36]">
        <div className="absolute -left-6 top-0 h-[84%] w-[40%] origin-top-left -skew-x-[5deg] bg-[linear-gradient(168deg,rgba(255,252,248,0.28)_0%,transparent_64%)] blur-[1px]" />
        <div className="absolute right-0 top-0 h-[86%] w-[44%] origin-top-right skew-x-[5deg] bg-[linear-gradient(195deg,rgba(255,252,248,0.26)_0%,transparent_60%)] blur-[1px]" />
        <div className="absolute left-[26%] top-0 h-28 w-28 rounded-full bg-white/[0.12] blur-2xl" />
...
/** Logo vorerst aus — Nebel/Overlay wirkte unsauber hinter TR/Nummer. */
