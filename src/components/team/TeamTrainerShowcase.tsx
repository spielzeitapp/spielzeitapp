        ...
        {trainers.map((trainer) => {
          ...
          return (
            <button
              ...
              className="group relative aspect-[4/5] w-[55vw] min-w-[190px] max-w-[220px] shrink-0 snap-start overflow-hidden rounded-[18px] border border-red-500/35 bg-[linear-gradient(145deg,#171719_0%,#080809_52%,#20090b_100%)] text-left shadow-[0_12px_30px_rgba(0,0,0,0.42)] transition active:scale-[0.985] sm:w-[240px] sm:max-w-[240px] sm:rounded-[22px]"
            >
