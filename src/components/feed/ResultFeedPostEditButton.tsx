    ...
    <>
      ...
      {open ? createPortal(
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="result-feed-image-dialog-title"
        >
            ...
            <div className="min-h-0 overflow-y-auto overscroll-contain p-5 pb-4 [-webkit-overflow-scrolling:touch]">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 id="result-feed-image-dialog-title" className="mt-1 text-2xl font-black text-white">Siegerbild bearbeiten</h2>
