...
const GK_GREEN_TOP = '#4ade80';
const GK_GREEN_MID = '#22c55e';
const GK_GREEN_BOTTOM = '#047857';
const GK_OUTLINE = '#6ee7b7';
  ...
  return (
    ...
    >
      <defs>
        ...
        {variant === 'goalkeeper' ? (
          <filter id={gkGlowFilterId} x="-45%" y="-45%" width="190%" height="190%">
      ...
      <g filter={bodyFilter}>
        ...
        <path
          ...
          strokeWidth={variant === 'goalkeeper' ? 1.1 : 0.85}
