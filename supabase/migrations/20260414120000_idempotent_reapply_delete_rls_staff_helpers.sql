-- Idempotent: gleiche Definitionen wie 20260413210000 — fuer Projekte, bei denen jene Migration
-- nie gelaufen ist oder Policies/Helper auf der DB noch veraltet sind.
-- Behebt u.a. invalid input value for enum membership_role beim DELETE (historisch: ungueltiges Rollen-Literal in RLS).
