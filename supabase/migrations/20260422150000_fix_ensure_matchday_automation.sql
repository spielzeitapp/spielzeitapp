-- ensure_matchday_automation: Spiele korrekt erkennen (kind ODER type) und
-- sinnvolles Zeitfenster (Wien-Kalender: heute … +14 Tage), damit Feed-Posts angelegt werden.
...
COMMENT ON FUNCTION public.ensure_matchday_automation IS
  'Matchday-Feed-Post (idempotent): Spiel über kind/type, Fenster Wien heute..+14d, rows_inserted 0/1.';
