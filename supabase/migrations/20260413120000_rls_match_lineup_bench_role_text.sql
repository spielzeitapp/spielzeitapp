-- Gleiche Rollenprüfung wie public.events (ms.role::text IN (...)),
-- damit INSERT/UPDATE/DELETE unter RLS zuverlässig greift (Enum-Literale vs. Text).
...
-- Anpfiff-Event: gleiche Rollenprüfung
